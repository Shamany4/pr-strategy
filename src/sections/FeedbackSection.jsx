...
const FeedbackSection = () => {
  ...
  const linksArrow = [
    ...
    {
      name: 'phone',
      url: 'tel:8-800-600-3535',
      viebox: '0 0 29.62 29.62',
    ...
    {
      name: 'mail',
      url: 'mailto:test@mail.ru',
      viebox: '0 0 29.24 29.24',
      ...
      <div className="feedback-social">
        <div className="feedback-social__figure"></div>
        {
          linksArrow.map((el, key) => {
            return (<span key={key} onMouseEnter={() => setActive(el.name)}><FeedbackSocialLink
              viebox={el.viebox}
              path_1={el.path_1}
              path_2={el.path_2}
              name={el.name}
