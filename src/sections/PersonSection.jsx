          ...
          <div className="swiper-wrapper">
            <div className="swiper-slide">
              <div className="m-person">
                ...
                <button
                  className="m-person__insta"
                  onClick={() => openUrlHandler('https://www.instagram.com/')}
                >
                  @igormalinin.ru
                </button>
                ...
                <div className="m-person-social">
                  <ul className="person-social m-person-social-list">
                    ...
                    <PersonSocialLink
                      viewBox="0 0 27.83 27.83"
                      url="https://www.instagram.com/igormalinin.ru/"
                      mobile={true}
                      path_1="M13.92,21A7.07,7.07,0,1,1,21,13.92,7.07,7.07,0,0,1,13.92,21ZM13.92,9a4.88,4.88,0,1,0,4.87,4.88A4.89,4.89,0,0,0,13.92,9Z"
                      circle={true}
                      cx={21.15}
            ...
            <div className="swiper-slide">
              <div className="m-person">
                ...
                <button className="m-person__insta"
                  onClick={() => openUrlHandler('https://www.instagram.com/')}
                >@milevskaya_pr_jvm</button>
