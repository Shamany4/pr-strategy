          ...
          <div className="d-flex flex-column person-column_three">
            ...
            <div className="instagram">
              <div className="instagram-photo">
                <img
                  src={!active ? insta_1 : insta_2}
                  alt={!active ? 'Игорь Малинин' : 'Юлианна Милевская'}
                  className="instagram-photo__image"
                />
              </div>
            ...
            <a href="#" className={!active ? 'person__link person__link_igor' : 'person__link'}>
            ...
            active
              ...
              <ul className="person-social">
                <li className="person-social__item">
                  <a href="#" className="person-social__link">
                    <svg viewBox="0 0 27.84 27.83" fill="white" stroke="white" strokeWidth={1}>
                      <linearGradient id="social-gradient">
                        <stop offset="0%" stopColor="#FF6E65" />
                        <stop offset="100%" stopColor="#C14C45" />
                      </linearGradient>
